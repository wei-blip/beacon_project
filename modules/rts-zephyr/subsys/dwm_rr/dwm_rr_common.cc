...
struct k_poll_signal sig_rx_dwm = K_POLL_SIGNAL_INITIALIZER(sig_rx_dwm);
struct k_poll_signal sig_tx_dwm = K_POLL_SIGNAL_INITIALIZER(sig_tx_dwm);
struct k_poll_event ev_dwm[2] = {
